  ...
  return ok(
    {
      ...
      endpoints: [
        ...
        { method: 'GET', path: '/api/settings', auth: 'public', desc: 'Public site settings (theme default, sections, socials).' },
        { method: 'POST', path: '/api/metrics', auth: 'public', desc: 'Record an analytics event. Body: { type, refId?, meta? }.' },
        { method: 'GET', path: '/api/comments?article=', auth: 'public', desc: 'Approved comments for a story.' },
        { method: 'POST', path: '/api/comments', auth: 'public', desc: 'Post a comment (goes to moderation).' },
        { method: 'GET', path: '/api/media/[id]', auth: 'public', desc: 'Stream an uploaded image (inline storage).' },
        { method: 'GET', path: '/api/admin/articles?q=&category=&publishState=&video=', auth: 'staff', desc: 'Console story listing (drafts included).' },
        { method: 'PATCH', path: '/api/admin/articles', auth: 'staff', desc: 'Bulk action: { ids, action }.' },
        { method: 'PATCH', path: '/api/admin/articles/[id]', auth: 'staff', desc: 'Quick flags (feature/breaking/state).' },
        { method: 'GET', path: '/api/admin/dashboard', auth: 'staff', desc: 'Console home KPIs + queues.' },
        { method: 'GET', path: '/api/admin/analytics?days=', auth: 'staff', desc: 'Events series + top stories.' },
        { method: 'GET', path: '/api/admin/media', auth: 'staff', desc: 'Media library.' },
        { method: 'POST', path: '/api/admin/media', auth: 'staff', desc: 'Upload (multipart) or register (JSON) media.' },
        { method: 'GET', path: '/api/admin/authors', auth: 'staff', desc: 'Author profiles + counts.' },
        { method: 'GET', path: '/api/admin/briefing?day=', auth: 'staff', desc: 'Daily briefing editor.' },
        { method: 'GET', path: '/api/admin/tips?status=', auth: 'staff', desc: 'Reader tip inbox.' },
        { method: 'GET', path: '/api/admin/tags', auth: 'staff', desc: 'Tag cloud with counts.' },
        { method: 'GET', path: '/api/admin/categories', auth: 'staff', desc: 'Categories with counts.' },
        { method: 'PUT', path: '/api/admin/categories', auth: 'admin', desc: 'Rename / recolour / reorder a category.' },
        { method: 'GET', path: '/api/admin/comments?status=', auth: 'admin', desc: 'Moderation queue.' },
        { method: 'GET', path: '/api/admin/users', auth: 'admin', desc: 'Accounts + roles.' },
        { method: 'GET', path: '/api/admin/subscribers?format=csv', auth: 'admin', desc: 'Newsletter list / export.' },
        { method: 'GET', path: '/api/admin/settings', auth: 'admin', desc: 'Full site settings.' },
        { method: 'GET', path: '/api/admin/audit', auth: 'admin', desc: 'Audit trail.' },
        { method: 'GET', path: '/api/admin/nav-counts', auth: 'staff', desc: 'Sidebar badge + notification bell counts.' },
      ],
    },
    'live',
  );
