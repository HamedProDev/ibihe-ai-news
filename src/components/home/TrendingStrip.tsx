...
export function TrendingStrip() {
  ...
  return (
    <section aria-labelledby="trending-h" className="rounded-2xl border border-white/10 bg-[#0d1a11] p-4 sm:p-5">
      <h2 id="trending-h" className="mb-4 flex items-center gap-2 text-base font-bold text-white">
        ...
        {items.map((a, i) => (
          <li key={a.id}>
            <Link href={`/amakuru/${a.id}`} className="group flex gap-3 focus:outline-none">
              <span
                aria-hidden
                className="text-4xl font-extrabold leading-none text-white/10 transition-colors group-hover:text-[#00c853]/40"
              >
              ...
              <span className="min-w-0">
                ...
                <span className="block text-sm font-semibold leading-snug text-white line-clamp-3 group-hover:text-[#00c853]">
