...
export function WhyMatters({ items }: { items: WhyItMatters[] }) {
  ...
  return (
    <section aria-labelledby="why-h" className="bg-[#0d1a11] border border-[#00c853]/20 rounded-2xl p-4 sm:p-5">
      <div className="flex items-center justify-between gap-2 mb-3">
        <h2 id="why-h" className="flex items-center gap-2 text-white text-[15px] font-bold">
          <HelpCircle size={16} className="text-[#00c853]" aria-hidden="true" />
      ...
      <p role="tabpanel" className="text-white/75 text-sm leading-relaxed">
